...
# replaced with a real measurement during Phase 3 hardware bring-up.
...
def compute_offset(
    ...
    candidates = []
    for ictus_t, expected_t in zip(practice_ictus_times, practice_expected_times):
        if ictus_t is None:
            continue
    ...
    return CalibrationResult(offset_s=offset_s)
